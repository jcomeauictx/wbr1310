...
function generateVS()
{
	...
	for (var i=1;i < 6;i++)
	{
		...
		if (sData[i] != "0")
		{
			...
			str+="<td width=217 width=20>&nbsp;<font face=\"Tahoma\" size=\"2\" color=\"#000000\"><strong>"+getConnectString(sData[i])+"</strong></font></td>";
		}
		else
		{
			str+="<td width=220 height=20>&nbsp;<img src=./pic/W_nolink.gif width=200 height=20 border=0></td>";
			str+="<td height=20>&nbsp;<font face=\"Tahoma\" size=\"2\" color=\"#000000\">"+getConnectString(sData[i])+"</font></td>";
		}
