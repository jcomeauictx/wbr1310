...
$m_pptp_ipaddr	= "PPTP IP Address";
$m_pptp_netmask	= "PPTP Subnet Mask";
$m_pptp_gateway	= "PPTP Gateway IP Address";
$m_pptp_server	= "PPTP Server IP Address<br>(may be same as gateway)";
