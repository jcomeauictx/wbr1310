<h1>SUPPORT MENU</h1>
 ...
 <tr>
 <td height=39> <a name=16><strong>Device Info </strong><br>
...
<strong><em>Wireless 802.11g - </em></strong>This displays the SSID, Channel, and whether or not Encryption is enabled on the Wireless interface. </td>
 </tr>
 <tr>
 <td height=20>&nbsp;</td>
 </tr>
 ...
 <tr>
 <td height=26><a name=17><b>Log</b></a><br> <br>
 <font size="2"> The <?query("/sys/modelname");?> keeps a running log of events and activities occurring on it at all times. The log will display up to 400 recent logs. Newer log activities will overwrite the older logs. <br>
 ...
 <strong><em>Clear - </em></strong> Clears the logs completely. </font></td>
 </tr>
 <tr>
 <td height=20>&nbsp;</td>
 </tr>
 ...
 <tr>
 <td height=2><a name=18><strong>Stats</strong></a><br> <br>
 The <?query("/sys/modelname");?> keeps statistic of the data traffic that it handles. You are able to view the amount of packets that the router has Received and Transmitted on the WAN, LAN, and Wireless interfaces.
<br>
...
<strong><em>Reset - </em></strong>Click this button to clear the counters. The traffic counter will reset when the device is rebooted. </td>
 ...
 <tr>
 <td height=2><a name=19><b>Wireless</b></a><br>
