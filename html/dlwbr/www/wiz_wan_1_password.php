...
<!-- ________________________________ Main Content Start ______________________________ -->
		...
		<tr>
			...
			<td class="l_tb" width="173">
				<input type=password id=password name=password size=20 maxlength=15 value="<?=$G_DEF_PASSWORD?>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><?=$m_verify_password?> :</td>
			<td class="l_tb">
				<input type=password id=password_v name=password_v size=20 maxlength=15 value="<?=$G_DEF_PASSWORD?>">
			</td>
		</tr>
		</table>
		<br>
