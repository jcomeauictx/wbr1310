 ...
 *
 * Version:	$Id: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/net/ipv4/route.c#1 $
 *
...
#ifdef CONFIG_HARDWARE_TURBO
int ip_route_input_slow_6(struct sk_buff *skb, u32 daddr, u32 saddr,
...
#ifdef CONFIG_HARDWARE_TURBO
	if (netdev_fastroute && !(flags&(RTCF_NAT|RTCF_MASQ|RTCF_DOREDIRECT)) && !lsrc)
#else
