/*
  ...
  $Header: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/scsi/osst.c#1 $";
