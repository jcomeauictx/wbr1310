...
static const char *mcdx_c_version
    = "$Id: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/cdrom/mcdx.c#1 $";
#endif
...
int __init mcdx_init(void)
{
	...
	xwarn("$Id: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/cdrom/mcdx.c#1 $\n");
