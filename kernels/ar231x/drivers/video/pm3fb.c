 ...
 *  more details.
 *
 *  $Header: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/video/pm3fb.c#1 $
 *
 *  CHANGELOG:
...
#endif
{
	...
	DPRINTK(2, "This is pm3fb.c, CVS version: $Header: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/video/pm3fb.c#1 $");
