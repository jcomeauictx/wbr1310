...
/* $Id: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/char/applicom.c#1 $			     */
...
int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/sw/linuxsrc/src/kernels/mips-linux-2.4.25/drivers/char/applicom.c#1 $\n");
