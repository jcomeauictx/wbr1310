...
#else
		inodep = (squashfs_reg_inode_header *)get_inode(sizeof(*reg) + offset * sizeof(unsigned int));
		inode = (squashfs_base_inode_header *)inodep;
#endif
...
#else
		inodep = (squashfs_symlink_inode_header *) get_inode(sizeof(*symlink) + byte);
		inode = (squashfs_base_inode_header *) inodep;
#endif
