...
static void action(const char * udn, const char * serviceid, void * param)
{
	...
	//dtrace("action(%s, %s)\n", udn, serviceid);
	build_action_result(req, "urn:schemas-upnp-org:service:Layer3Forwarding:1");
}
...
void add_L3Forwarding1(void)
{
	upnp_add_service("urn:upnp-org:serviceId:L3Forwarding1",
